...
import cn.time.nft.turbo.api.collection.response.*;
...
import static cn.time.nft.turbo.api.collection.constant.CollectionStateEnum.SUCCEED;
...
import static cn.time.nft.turbo.collection.exception.CollectionErrorCode.COLLECTION_INVENTORY_UPDATE_FAILED;
