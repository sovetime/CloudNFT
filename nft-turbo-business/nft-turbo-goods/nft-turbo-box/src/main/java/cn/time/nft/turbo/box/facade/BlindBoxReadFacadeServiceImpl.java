package cn.time.nft.turbo.box.facade;

import cn.time.nft.turbo.api.box.model.BlindBoxItemVO;
import cn.time.nft.turbo.api.box.model.BlindBoxVO;
import cn.time.nft.turbo.api.box.model.HeldBlindBoxVO;
import cn.time.nft.turbo.api.box.request.BlindBoxItemPageQueryRequest;
import cn.time.nft.turbo.api.box.request.BlindBoxPageQueryRequest;
import cn.time.nft.turbo.api.box.service.BlindBoxReadFacadeService;
...
import cn.time.nft.turbo.box.domain.entity.convertor.BlindBoxConvertor;
import cn.time.nft.turbo.box.domain.entity.convertor.BlindBoxItemConvertor;
...
import static cn.time.nft.turbo.box.exception.BlindBoxErrorCode.BLIND_BOX_NOT_EXIST;
