package cn.time.nft.turbo.box.domain.service.impl;

import cn.time.nft.turbo.api.box.constant.BlindAllotBoxRule;
import cn.time.nft.turbo.api.box.request.BlindBoxCreateRequest;
import cn.time.nft.turbo.api.box.request.BlindBoxItemCreateRequest;
import cn.time.nft.turbo.api.goods.constant.GoodsEvent;
import cn.time.nft.turbo.api.goods.request.*;
import cn.time.nft.turbo.api.goods.response.GoodsSaleResponse;
import cn.time.nft.turbo.base.response.PageResponse;
import cn.time.nft.turbo.box.domain.entity.BlindBox;
import cn.time.nft.turbo.box.domain.entity.BlindBoxInventoryStream;
import cn.time.nft.turbo.box.domain.entity.BlindBoxItem;
import cn.time.nft.turbo.box.domain.request.BlindBoxAssignRequest;
import cn.time.nft.turbo.box.domain.request.BlindBoxBindMatchRequest;
import cn.time.nft.turbo.box.domain.service.BlindBoxItemService;
import cn.time.nft.turbo.box.domain.service.BlindBoxRuleServiceFactory;
import cn.time.nft.turbo.box.domain.service.BlindBoxService;
import cn.time.nft.turbo.box.exception.BlindBoxException;
import cn.time.nft.turbo.box.infrastructure.mapper.BlindBoxInventoryStreamMapper;
import cn.time.nft.turbo.box.infrastructure.mapper.BlindBoxMapper;
...
import static cn.time.nft.turbo.box.exception.BlindBoxErrorCode.*;
