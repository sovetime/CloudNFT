package cn.time.nft.turbo.goods.service;

import cn.time.nft.turbo.api.goods.constant.GoodsType;
import cn.time.nft.turbo.api.goods.model.GoodsBookVO;
...
import cn.time.nft.turbo.goods.entity.GoodsBook;
import cn.time.nft.turbo.goods.entity.convertor.GoodsBookConvertor;
import cn.time.nft.turbo.goods.infrastructure.mapper.GoodsBookMapper;
...
import static cn.time.nft.turbo.goods.service.HotGoodsService.HOT_GOODS_BOOK_COUNT;
