...
import cn.time.nft.turbo.api.box.constant.BlindBoxStateEnum;
import cn.time.nft.turbo.api.chain.model.ChainOperateBody;
import cn.time.nft.turbo.api.chain.response.data.ChainResultData;
import cn.time.nft.turbo.api.collection.constant.CollectionStateEnum;
...
import cn.time.nft.turbo.collection.domain.service.CollectionService;
import cn.time.nft.turbo.collection.domain.service.impl.HeldCollectionService;
...
import static cn.time.nft.turbo.box.exception.BlindBoxErrorCode.BLIND_BOX_INVENTORY_UPDATE_FAILED;
import static cn.time.nft.turbo.collection.exception.CollectionErrorCode.COLLECTION_QUERY_FAIL;
import static cn.time.nft.turbo.collection.exception.CollectionErrorCode.HELD_COLLECTION_QUERY_FAIL;
