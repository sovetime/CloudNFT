package cn.time.nft.turbo.user.domain.service;

import cn.time.nft.turbo.api.user.constant.UserOperateTypeEnum;
import cn.time.nft.turbo.api.user.constant.UserStateEnum;
import cn.time.nft.turbo.api.user.request.UserActiveRequest;
import cn.time.nft.turbo.api.user.request.UserAuthRequest;
import cn.time.nft.turbo.api.user.request.UserModifyRequest;
import cn.time.nft.turbo.api.user.response.UserOperatorResponse;
import cn.time.nft.turbo.api.user.response.data.InviteRankInfo;
...
import cn.time.nft.turbo.user.domain.entity.User;
import cn.time.nft.turbo.user.domain.entity.convertor.UserConvertor;
import cn.time.nft.turbo.user.infrastructure.exception.UserErrorCode;
import cn.time.nft.turbo.user.infrastructure.exception.UserException;
import cn.time.nft.turbo.user.infrastructure.mapper.UserMapper;
...
import static cn.time.nft.turbo.user.infrastructure.exception.UserErrorCode.*;
