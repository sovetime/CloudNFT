package cn.time.nft.turbo.datasource.config;

import cn.time.nft.turbo.datasource.handler.DataObjectHandler;
...
@Configuration
@MapperScan(basePackages = "cn.time.nft.turbo.*.infrastructure.mapper")
