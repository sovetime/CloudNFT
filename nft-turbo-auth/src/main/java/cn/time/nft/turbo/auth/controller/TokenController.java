...
import cn.time.nft.turbo.auth.constant.TokenSceneEnum;
import cn.time.nft.turbo.auth.exception.AuthErrorCode;
import cn.time.nft.turbo.auth.exception.AuthException;
import cn.time.nft.turbo.web.util.TokenUtil;
...
import static cn.time.nft.turbo.cache.constant.CacheConstant.CACHE_KEY_SEPARATOR;
import static cn.time.nft.turbo.web.util.TokenUtil.TOKEN_PREFIX;
